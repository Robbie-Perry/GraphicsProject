...
namespace asgn5v1
{
	...
	public class Transformer : System.Windows.Forms.Form
	{
		...
		public Transformer()
		{
			...
			Text = "COMP 4560:  Assignment 5 (200830) Robbie Perry";
			ResizeRedraw = true;
        ...
        private double[,] MultiplyMatricies(double[,] A, double[,] B)
        {
            ...
            {
                double[,] c = new double[A.GetLength(1), B.GetLength(0)];
        ...
        private double[,] GetTranslationMatrix(double x, double y, double z)
        {
            return new double[,] {
                { 1, 0, 0, 0 },
                { 0, 1, 0, 0 },
        ...
        private double[,] GetScalingMatrix(double x, double y, double z)
        {
            return new double[,] {
                { x, 0, 0, 0 },
                { 0, y, 0, 0 },
